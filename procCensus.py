...
def MakeUrbanCores(in_Blocks, out_Cores):
   ...
   while c1 > c0:
      ...
      arcpy.SelectLayerByLocation_management ('lyr_SecondaryBlocks', 'WITHIN_A_DISTANCE', 'lyr_SecondaryBlocks', '0 METERS', 'ADD_TO_SELECTION')
      c1 = countSelectedFeatures('lyr_SecondaryBlocks')
...
def main():
   ...
   # Set up variables
   in_Blocks = r'L:\David\GIS_data\NHGIS\blocks_pop_2010\CensusBlocks2010.gdb\CensusBlocks2010_70mile'
   # blocks subset to an additional 20 miles around the processing buffer, i.e., 70 miles around Virginia.
   in_PopTab = r'L:\David\GIS_data\NHGIS\blocks_pop_2010\CensusBlocks2010.gdb\CensusBlocks2010_Pop'
   in_Imperv = r'L:\David\GIS_data\NLCD\NLCD_2016_Impervious_L48_20190405\NLCD_2016_Impervious_L48_20190405.img'
   in_Imperv20 = r'L:\David\GIS_data\NHGIS\blocks_pop_2010\CensusBlocks2010.gdb\imperv2016_20plus'
   out_Tracts = r'L:\David\GIS_data\NHGIS\blocks_pop_2010\CensusBlocks2010.gdb\CensusTracts2010_70mile'
   in_Year = 2010
   # in_Tracts = out_Tracts
   # out_Cores = r'C:\Users\xch43889\Documents\Working\ConsVision\VulnMod\CensusWork2000.gdb\UrbanCores2000'
   out_Cores = r'L:\David\GIS_data\NHGIS\blocks_pop_2010\CensusBlocks2010.gdb\UrbanCores2010_method3'
